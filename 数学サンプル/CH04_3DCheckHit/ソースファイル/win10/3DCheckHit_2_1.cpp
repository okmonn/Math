...
int CheckHit( XMFLOAT3 *pv3Triangle, XMFLOAT3 *pv3Point )
{
	...
	// それぞれの外積
	// XZ座標系で求める
	fCross0 = v3TriVec0.x * v3HitVec0.z - v3HitVec0.x * v3TriVec0.z;
	fCross1 = v3TriVec1.x * v3HitVec1.z - v3HitVec1.x * v3TriVec1.z;
	fCross2 = v3TriVec2.x * v3HitVec2.z - v3HitVec2.x * v3TriVec2.z;
	bHit = FALSE;
	...
	return fCross0 * fCross1 >= 0 && fCross0 * fCross2 >= 0;
}
