...
void SetDepthStencilState(){
	...
	hr = g_pd3dDevice->CreateDepthStencilState(&dsDesc, &g_pDSStencilState2);

	//g_pImmediateContext->OMSetDepthStencilState(g_pDSStencilState2, 1);
}
// Direct3Dの初期化
...
int Cleanup( void )
{
	...
	SAFE_RELEASE(g_pDSStencilState2);						// Zバッファのステート
